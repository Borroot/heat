...
is that the straightforward way to do manual messages causes one thread to do all of the reduction work. Whereas the MPI reduction methods will automatically optimize the message structure to divide the reduction work across the threads as much as possible. 
...
\begin{itemize}
    \item \textbf{Steven Bronsveld and Wouter Damen} worked on the MPI code.
